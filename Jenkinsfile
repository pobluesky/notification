pipeline {
    ...
    environment {
        ...
        REPO_URL = 'https://github.com/pobluesky/notification.git'
        BRANCH_NAME = 'main'
        ECR_URI = '014498623207.dkr.ecr.ap-northeast-2.amazonaws.com/notification'
        IMAGE_TAG = "notification:${env.BUILD_ID}"
        LATEST_TAG = "latest"
    }
